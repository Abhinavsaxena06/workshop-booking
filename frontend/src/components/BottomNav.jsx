...
function BottomNav() {
  ...
  // Nav items — to add a new one, just add an object here
  const navItems = [
    {
      path: '/',
      label: 'Home',
  ...
  return (
    /*
      fixed bottom-0 — sticks to the bottom of the screen always
      md:hidden — completely disappears on desktop (tablet and above)
      z-50 — stays on top of all page content
      grid grid-cols-4 — 4 equal columns, one per nav item
    */
