      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-xs text-gray-500 dark:text-slate-400 mb-1">
            ...
            <span className={urgent ? 'text-red-600 dark:text-red-400 font-semibold' : 'text-gray-600 dark:text-slate-300'}>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-pink-50 to-orange-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-gray-900 dark:text-white leading-tight mb-4">
            Free Workshops to
          </h1>

          <div
            className="text-5xl md:text-7xl font-black mb-6 min-h-[1.2em]"
            style={{
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/workshops"
              className="group relative inline-block px-8 py-4 rounded-2xl font-bold text-white text-lg transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-105 hover:shadow-2xl active:scale-95"
          ...
          <div className="mt-16 flex flex-col items-center gap-2 text-gray-400 dark:text-slate-400">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mt-4 mb-2">
            Numbers that speak
          </h2>

          <p className="text-gray-500 dark:text-slate-300 text-lg mb-12">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-slate-300">Pick a topic and find the right workshop</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
          {workshopCategories.map((cat, i) => (
            <Link
              ...
              key={i}
              className="rounded-2xl p-5 flex items-center gap-4 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-pointer dark:bg-slate-800/40"
              style={{
            ...
            >
              ...
              <div>
                <div className="font-bold text-gray-800 dark:text-white text-base">{cat.name}</div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-end justify-between mb-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-1">
                Upcoming workshops
              </h2>
              <p className="text-gray-500 dark:text-slate-300">Seats filling up fast</p>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 dark:text-slate-300 mb-12">From browsing to attending in minutes</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="rounded-3xl p-8 text-center dark:bg-slate-800/50"
                style={{
                  backgroundColor: step.color + '10',
                  border: `2px solid ${step.color}35`,
                }}
              >
                <div className="text-7xl font-black mb-4" style={{ color: step.color, opacity: 0.15 }}>
                  {step.n}
                </div>

                <div
                  className="text-4xl mb-3 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto"
                  style={{ backgroundColor: step.color + '20' }}
                >
                  {step.icon}
                </div>

                <h3 className="text-xl font-black text-gray-800 dark:text-white mb-2">{step.title}</h3>
                <p className="text-gray-500 dark:text-slate-300 text-sm leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div
            className="rounded-3xl p-10 md:p-16 bg-white/90 dark:bg-slate-800/80 border border-indigo-100 dark:border-slate-700"
            style={{
          ...
          >
            ...
            <p className="text-gray-500 dark:text-slate-300 text-lg mb-8">
            ...
            {!isLoggedIn && (
              <Link
                to="/register"
                className="inline-block px-10 py-4 rounded-2xl font-black text-white text-lg hover:scale-105 transition-transform duration-200"
                style={{
